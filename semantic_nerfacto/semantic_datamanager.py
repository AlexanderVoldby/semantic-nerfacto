...
from semantic_nerfacto.semantic_dataset import SemanticDataset
...
# The only change to this file. Use semantic dataset instead of input dataset
TDataset = TypeVar("TDataset", bound=SemanticDataset, default=SemanticDataset)
